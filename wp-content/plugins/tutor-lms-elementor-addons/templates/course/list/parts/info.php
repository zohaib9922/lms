...
$show_avatar 		= $settings['course_list_avatar_settings'];
$show_author 		= $settings['course_list_author_settings'];
$show_categories 	= $settings['course_list_category_settings'];
?>
